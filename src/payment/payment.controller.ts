...
export class PaymentController {
  ...
  @ApiResponse({
    status: 400,
    description:
      'Payment already exists|Invalid invoice_id|Invalid purchase_id|Price must be a positive number|Invalid success',
  })
  @ApiResponse({
    status: 403,
  ...
  @ApiResponse({
    status: 400,
    description:
      'Page must be a positive number|Limit must be a positive number|Invalid success',
  })
  @ApiResponse({
    status: 404,
