...
export class HostImageController {
  ...
  @ApiResponse({
    status: 400,
    description:
      'HostImage already exists|Host_id must be a positive number|Width must be a positive number|Height must be a positive number|Invalid url',
  })
  @ApiResponse({
    status: 403,
  ...
  @ApiResponse({
    status: 400,
    description:
      'Host_id must be a positive number|Width must be a positive number|Height must be a positive number|Invalid url',
  })
  @ApiResponse({
    status: 403,
    description: "You don't have permission to do that",
