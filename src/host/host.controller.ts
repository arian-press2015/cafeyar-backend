...
export class HostController {
  ...
  @ApiResponse({
    status: 400,
    description:
      'Name already exists|Phone number already taken|Name must be a string|Invalid phone|Address must be a string|Destination must be a string|Invalid opening_time|Invalid closing_time',
  })
  async create(
  ...
  @ApiResponse({
    status: 400,
    description:
      'Name already exists|Name must be a string|Invalid phone|Address must be a string|Destination must be a string|Invalid opening_time|Invalid closing_time',
  })
  @ApiResponse({
    status: 404,
