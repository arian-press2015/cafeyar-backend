...
export class DiscountController {
  ...
  @ApiResponse({
    status: 400,
    description:
      'Discount code already taken|Invalid code|Count must be a positive number|Percentage must be a positive number|Max_amount must be a positive number|Invalid expiry_date|Invalid products',
  })
  @ApiResponse({
    status: 403,
  ...
  @ApiResponse({
    status: 400,
    description:
      'Invalid code|Count must be a positive number|Percentage must be a positive number|Max_amount must be a positive number|Invalid expiry_date|Invalid products',
  })
  @ApiResponse({
    status: 403,
    description: "You don't have permission to do that",
